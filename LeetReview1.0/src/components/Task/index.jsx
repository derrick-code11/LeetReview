...
/**
 * @param {{ task: { title: string, description: string, priority: string, deadline: number, image?: string, alt?: string, tags: { title: string, bg: string, text: string }[] }, provided: any }} props
 */
